...
class Seq2SeqModel(nn.Module):
    ...
    def __init__(
        ...
        if model_type == "cnn_lstm":
            ...
            raise ValueError(f"Invalid model type: {model_type}. Expected 'cnn_lstm' or 'resnet_lstm'.")
    ...
    def forward(
        ...
        decoder_output = self.decoder(
            ...
            target_sequence=target_sequences[:, :-1]  # Exclude the last token (end token)
        )
    ...
    def _greedy_search(
        ...
        """
        Perform greedy or sampling-based decoding.
        ...
        input_token = torch.tensor([[start_token_id]] * batch_size, device=device)
        ...
        for _ in range(max_length):
            ...
            output, hidden = self.decoder.decode_step(encoder_output, input_token, hidden)
            ...
            sequence.append(next_token_item)
            
            # Break if we generated an end token
    ...
    def _beam_search(
        ...
        for step in range(max_length):
            ...
            if step == 0:
                ...
                top_k_scores, top_k_indices = torch.topk(scores, beam_size - len(finished_sequences))
        ...
        sorted_sequences = [seq for _, seq in sorted(
